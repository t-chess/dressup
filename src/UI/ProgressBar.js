export default class ProgressBar extends Phaser.GameObjects.Container {
    ...
    createBar() {
        this.progressBox = this.scene.add.panel(0, 0, 'sm', this.width, 2);
        this.add(this.progressBox);

        this.progressBar = this.scene.add.graphics();
        this.add(this.progressBar);

        this.playButton = this.scene.add.panel((this.width-5)*10, 0, "sm", 5, 2, "Play", undefined, this.onComplete)
    ...
    updateProgress(value) {
        ...
        this.progressBar.clear()
            ...
            .fillRect(13, 13, (this.width*20*value)-26, 16);
    }
    completeLoad() {
